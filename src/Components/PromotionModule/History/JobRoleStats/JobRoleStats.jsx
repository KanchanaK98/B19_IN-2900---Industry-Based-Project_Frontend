            ...
            <Grid item md={6}>
              <Card square className={classes.card2}>
                <Grid container>
                  ...
                  <Grid item md={5} className={classes.content}>
                    <Typography variant="h2">{jobRoleStats.SoftwareEngineer < 10
                        ? "0" + jobRoleStats.SoftwareEngineer
                        : jobRoleStats.SoftwareEngineer}</Typography>
            ...
            <Grid item md={6}>
              <Card square className={classes.card2}>
                <Grid container>
                  ...
                  <Grid item md={5} className={classes.content}>
                    <Typography variant="h2">{jobRoleStats.SoftwareArchitect < 10
                        ? "0" + jobRoleStats.SoftwareArchitect
                        : jobRoleStats.SoftwareArchitect}</Typography>
                    <Typography variant="h6">Software</Typography>
            ...
            <Grid item md={6}>
              <Card square className={classes.card2}>
                <Grid container>
                  ...
                  <Grid item md={5} className={classes.content}>
                    <Typography variant="h2">{jobRoleStats.UIUXDesigner < 10
                        ? "0" + jobRoleStats.UIUXDesigner
                        : jobRoleStats.UIUXDesigner}</Typography>
